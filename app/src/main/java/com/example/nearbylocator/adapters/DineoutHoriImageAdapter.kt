...
class DineoutHoriImageAdapter(private val horiImageList: List<EventDataClass>) :
    ...
    override fun onCreateViewHolder(
        ...
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.card_event_hori, parent, false)
