...
object PlaceCategoryItems {
    fun getPlaceCategories(): List<PlaceItem> {
        return listOf(
            ...
            // Personal Care
            PlaceItem.Header("Personal Care", R.drawable.place_category_icon_saloon),
            PlaceItem.CategoryItem(
                PlaceTypeIcon(
                    "Salon",
            ...
            // Transportation
            PlaceItem.Header("Transportation", R.drawable.place_category_icon_busstop),
            PlaceItem.CategoryItem(
                PlaceTypeIcon(
                    "Bus Stop",
            ...
            // Public Services
            PlaceItem.Header("Public Services", R.drawable.place_category_icon_policestation),
            PlaceItem.CategoryItem(
                PlaceTypeIcon(
                    "Police Station",
            ...
            // Entertainment
            PlaceItem.Header("Entertainment", R.drawable.place_category_icon_park),
            PlaceItem.CategoryItem(
                PlaceTypeIcon(
                    "Park",
            ...
            // Education
            PlaceItem.Header("Education", R.drawable.place_category_icon_school),
            PlaceItem.CategoryItem(
                PlaceTypeIcon(
                    "School",
            ...
            // Religious
            PlaceItem.Header("Religious", R.drawable.place_category_icon_temple),
            PlaceItem.CategoryItem(
                PlaceTypeIcon(
                    "Church",
