...
class VertiImageAdapter(private val vertiImageList: List<VertiFoodsDataClass>) :
    ...
    override fun onCreateViewHolder(
        ...
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.food_verti_card, parent, false)
